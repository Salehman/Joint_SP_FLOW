function [output]=FLOW_inversion(TRUE_DATA,TN,MaxI,OB,...
...
while iteration<maxiteration
    ...
    [states1]=FR_MRST_MATRIX2(NX,NY,NZ,L,W,H,fluid,p_init,dt,NT,wc,...
        K_Ix,K_Ix,K_Ix,phi,CR,CF,Q,bc);
...
tic
    parfor KK=1:TN
        [states1]=FR_MRST_MATRIX2(NX,NY,NZ,L,W,H,fluid,p_init,dt,NT,wc,...
        K_Ixj2(:,KK),K_Ix,K_Ix,phi,CR,CF,Q,bc);
...
GI=(inv(J'*J+(alphaalpha^2)*(RM'*RM))*J');
output{1}=K_Ix;
output{2}=misfit;
output{3}=J;
output{4}=GI*J;
